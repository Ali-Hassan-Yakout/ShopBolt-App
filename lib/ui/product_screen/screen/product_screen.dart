...
import 'package:shopbolt/ui/product_screen/manager/product_screen_cubit.dart';
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: BlocBuilder<ProductScreenCubit,
                              ProductScreenState>(
                            buildWhen: (previous, current) =>
                                current is InCartChange,
                            builder: (context, state) => Text(
                              cubit.inCart ? S().removeFromCart : S().addToCart,
                              style: TextStyle(
                                  fontSize: 19.sp,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold),
