...
import 'package:shopbolt/ui/order_action_screen/screen/order_action_screen.dart';
import 'package:shopbolt/ui/order_details_screen/manager/order_details_screen_cubit.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  padding: EdgeInsets.all(15.sp),
                                  color:
                                      const Color.fromRGBO(255, 214, 164, 1.0),
                                  child: Row(
                                    children: [
                                      Text(
                                        S().date,
                                ...
                                Container(
                                  padding: EdgeInsets.all(15.sp),
                                  color:
                                      const Color.fromRGBO(255, 198, 99, 1.0),
                                  child: Row(
                                    children: [
                                      Text(
                                        S().price,
